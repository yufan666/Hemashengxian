    ...
    private void initEvent() {
        ...
        mBtnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(ActivityLoginAct.this,MainActivity.class);
        ...
        mRegist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent();
                intent.setClass(ActivityLoginAct.this,ActivityRegisterAct.class);
                startActivity(intent);
            }
        });
        mForgetPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent();
                intent.setClass(ActivityLoginAct.this,ActivityFoundAct.class);
                startActivity(intent);
            }
        });
    }
